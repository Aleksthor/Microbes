...
public class Matrix
{
    ...
    public void Mutate(int _rows, int _cols, float mutation_rate)
    {
        mat[_rows][_cols] += UnityEngine.Random.Range(-1.0f, 1.0f) * mutation_rate;
        mat[_rows][_cols] = Mathf.Clamp(mat[_rows][_cols], -1f, 1f);
    }
